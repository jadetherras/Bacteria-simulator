...
std::string const INFECTION = "infection";
std::string const NOMBRE_DE_VIRUS = "virus";
std::string const NOMBRE_INFECTION = "infectes en %";
std::string const GENERATION = "Generation moyenne";
